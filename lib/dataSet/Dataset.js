...
function Dataset(id,locals,name,boundingBox){_classCallCheck(this,Dataset);this.id="";this.locals=[];this.name="";this.boundingBox=[];
this.id=id;
this.locals=locals;
this.name=name;
...
return new Dataset(this.id+'-OPEN',this.locals.filter(function(l){return l.isOpenAt(time);}),this.name,this.boundingBox);
