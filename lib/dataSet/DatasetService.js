...
datasetId){var userPosition,currentDataset,dataset,r,datasetInfo,datasetBoundingBox,datasetName,response,featuresCollection,locals,foundDataset;return _regenerator2.default.async(function getDataset$(_context){while(1){switch(_context.prev=_context.next){case 0:if(!(
datasetId==null)){_context.next=8;break;}_context.next=3;return _regenerator2.default.awrap(
...
dataset);case 11:_context.next=13;return _regenerator2.default.awrap(


fetch('https://api.mapbox.com/datasets/v1/'+mapboxStudioUsername+'/'+datasetId+'?access_token='+accessToken));case 13:r=_context.sent;_context.next=16;return _regenerator2.default.awrap(
...
datasetName=datasetInfo.name;_context.next=23;return _regenerator2.default.awrap(

fetch('https://api.mapbox.com/datasets/v1/'+mapboxStudioUsername+'/'+datasetId+'/features?access_token='+accessToken));case 23:response=_context.sent;_context.next=26;return _regenerator2.default.awrap(
...
dataset);case 38:case'end':return _context.stop();}}},null,this);}},{key:'getDatasets',value:function getDatasets(){var r,datasetList;return _regenerator2.default.async(function getDatasets$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:_context2.next=2;return _regenerator2.default.awrap(




fetch('https://api.mapbox.com/datasets/v1/'+mapboxStudioUsername+'?access_token='+accessToken));case 2:r=_context2.sent;_context2.next=5;return _regenerator2.default.awrap(
...
_promise2.default.all(datasetList.map(function(dataset){return DatasetService.getDataset(dataset.id);})));case 10:case'end':return _context2.stop();}}},null,this);}},{key:'getBoundingBox',value:function getBoundingBox()
