...
fetch('https://api.mapbox.com/datasets/v1/'+_Config2.default.mapboxStudioUsername+'/'+datasetId+'?access_token='+_Config2.default.accessToken));case 13:r=_context.sent;_context.next=16;return _regenerator2.default.awrap(
...
fetch('https://api.mapbox.com/datasets/v1/'+_Config2.default.mapboxStudioUsername+'/'+datasetId+'/features?access_token='+_Config2.default.accessToken));case 23:response=_context.sent;_context.next=26;return _regenerator2.default.awrap(
