...
fetch('https://api.mapbox.com/directions/v5/mapbox/'+transportMode+'/'+coords+'?geometries=geojson&access_token='+accessToken));case 3:routeResponse=_context.sent;_context.next=6;return _regenerator2.default.awrap(
...
fetch('https://api.mapbox.com/directions/v5/mapbox/'+transportMode+'/'+coords+'?geometries=geojson&access_token='+accessToken));case 14:routeResponse=_context.sent;_context.next=17;return _regenerator2.default.awrap(
