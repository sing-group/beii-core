...
{var _ref=arguments.length>2&&arguments[2]!==undefined?arguments[2]:{},_ref$endpoint=_ref.endpoint,endpoint=_ref$endpoint===undefined?'https://api.tiles.mapbox.com':_ref$endpoint,_ref$source=_ref.source,source=_ref$source===undefined?'mapbox.places':_ref$source,_ref$accessToken=_ref.accessToken,accessToken=_ref$accessToken===undefined?_Config2.default.accessToken:_ref$accessToken,_ref$proximity=_ref.proximity,proximity=_ref$proximity===undefined?'':_ref$proximity,_ref$bbox=_ref.bbox,bbox=_ref$bbox===undefined?'':_ref$bbox,_ref$types=_ref.types,types=_ref$types===undefined?'':_ref$types;
