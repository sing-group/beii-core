...
function doSearch(uri){var response;return regeneratorRuntime.async(function doSearch$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return regeneratorRuntime.awrap(
fetch(uri));case 2:response=_context.sent;_context.next=5;return regeneratorRuntime.awrap(
